"""STAGED, NOT IN USE. Vectorised sidm_scatter (12.6x faster: 17.6 -> 1.4 ms/call).

NOT wired into dmlab. Adopt ONLY after the 20-seed physics equivalence test passes
(a 5-seed check showed beta differing at 2.09 sigma -- too marginal to accept).
To adopt: copy over sidm.py, rerun the A/B test, and update VALIDITY.md.
NOTE: this version also FIXES the kappa undercount; the live sidm.py still has it,
so live kappa readings need the 1/0.716 correction.
"""
#!/usr/bin/env python3
"""
